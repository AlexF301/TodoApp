...
Copy com.android.todoapp-1.0.jar from the `target` folder and all other libraries located in `target/lib` to your project's lib folder.
...
// create a client
final TodoappClient client = factory.build(TodoappClient.class);
